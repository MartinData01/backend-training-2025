...
const retrainingForYou = 1500;
const sportBudget = 3000;
...
let AlexBudget = sportBudget-(yogaClass*3+retrainingClass+retrainingForYou);
...
let groupClassesTotal = groupClasses*2;
...
// 將 a 的值重新賦予了 13 的數字型別
// 將 a 的值重新賦予成變數 b ，並加 4
// 將變數 a 減變數 b
// 將變數 b 重新賦予值為 b+1
...
// numberArr1= [25, 30, 35] , numberArr2 = [25, 30, 35]

// 宣告一個 numberArr1 的變數，並賦予值 [5, 10, 15] 的陣列
// 宣告一個 numberArr2 的變數，值等於 numberArr1
// numberArr2 陣列加入數字 20
// numberArr2 重新賦予值 [25, 30, 35] 的陣列
// 使用 console 顯示 numberArr1 與 numberArr2 的值